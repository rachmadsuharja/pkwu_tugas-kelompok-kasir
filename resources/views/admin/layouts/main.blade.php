...
<head>
    ...
    <body class="nav-fixed">
        ...
        {{-- <script src="{{ asset('templates/js/datatables.js') }}" crossorigin="anonymous"></script> --}}
        <script src="{{ asset('templates/simple-datatables/dist/umd/simple-datatables.js') }}" crossorigin="anonymous"></script>
        <script src="{{ asset('templates/sb-admin-pro/js/datatables/datatables-simple-demo.js') }}"></script>
        ...
        <script src="{{ asset('templates/js/sweetalert2.js') }}"></script>
        @yield('script')
</body>
